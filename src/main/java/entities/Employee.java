...
//    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_GEN")
	...
	public int hashCode() {
		return Objects.hash(acNumber, bankCode, bankName, basicSalary, birthDate, contractType, cprExpiryDate,
				cprIssuedDate, cprNo, deptCode, electricityGuarantee, empName, externalBankLoanGuarantee, gosiAmount,
				gosiNo, gosiRegistrationDate, housingBankAmount, id, loanInstallment, nationality, nshAllowance,
				offBoardingDate, onBoardingDate, otherAllowance, passage, passportExpiryDate, passportIssuedDate,
				passportNo, paymentMode, profession, rentAllowance, residencePermitExpiryDate, residencePermitIssueDate,
				residencePermitNo, specialAllowance, telephoneGuarantee, ticket, travelAllowance, workDesignation);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(acNumber, other.acNumber) && Objects.equals(bankCode, other.bankCode)
				...
				&& Objects.equals(deptCode, other.deptCode)
				&& Objects.equals(electricityGuarantee, other.electricityGuarantee)
	...
	public String toString() {
		return "Employee [id=" + id + ", empName=" + empName + ", birthDate=" + birthDate + ", nationality="
				+ nationality + ", passportNo=" + passportNo + ", passportIssuedDate=" + passportIssuedDate
				+ ", passportExpiryDate=" + passportExpiryDate + ", cprNo=" + cprNo + ", cprIssuedDate=" + cprIssuedDate
				+ ", cprExpiryDate=" + cprExpiryDate + ", gosiNo=" + gosiNo + ", gosiRegistrationDate="
				+ gosiRegistrationDate + ", onBoardingDate=" + onBoardingDate + ", offBoardingDate=" + offBoardingDate
				+ ", profession=" + profession + ", workDesignation=" + workDesignation + ", deptCode=" + deptCode
				+ ", contractType=" + contractType + ", residencePermitNo=" + residencePermitNo
				+ ", residencePermitIssueDate=" + residencePermitIssueDate + ", residencePermitExpiryDate="
				+ residencePermitExpiryDate + ", passage=" + passage + ", ticket=" + ticket + ", basicSalary="
				+ basicSalary + ", bankCode=" + bankCode + ", acNumber=" + acNumber + ", paymentMode=" + paymentMode
				+ ", rentAllowance=" + rentAllowance + ", travelAllowance=" + travelAllowance + ", specialAllowance="
				+ specialAllowance + ", gosiAmount=" + gosiAmount + ", housingBankAmount=" + housingBankAmount
				+ ", telephoneGuarantee=" + telephoneGuarantee + ", electricityGuarantee=" + electricityGuarantee
				+ ", externalBankLoanGuarantee=" + externalBankLoanGuarantee + ", bankName=" + bankName
